  ...
  <div class="profile">
    ...
    <header>
      ...
      <div class="logout banner" v-else>
        <van-image width="1.76rem" height="1.76rem" :src="mobileStr" />
        <router-link class="text" to="/login">登录 / 注册</router-link>
      </div>
    </header>
    <!-- 主体 -->
    <main>
...
import mobileStr from '@/assets/images/mobile.png'
  ...
  methods: {
    ...
    async getUserInfo() {
      try {
        ...
        // js和400，507给程序员提示，401是给用户提示，重新登录
